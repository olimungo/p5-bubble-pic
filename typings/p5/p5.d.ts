...
declare namespace p5 {
    ...
    class FFT {
         ...
         *
         *   â€¢ FFT.waveform() computes amplitude values along
         ...
         *   sample of time.
         *
         *   â€¢ FFT.analyze()  computes amplitude values along
    ...
    class Env {
         ...
         *   Web Audio Parametersâ€”for example, a p5.Env can
